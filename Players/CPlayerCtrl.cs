...
public class CPlayerCtrl : MonoBehaviour {
    ...
    public void FixedUpdateGOF()
    {
        ...
        if (strongStunnedTime > 0)
        {
            ...
            {
                strongStunnedTime = 0;
                //moveSetScript.OnResetStunnedParticle();
        ...
        if (shakeWeight > 0)
        {
            ...
            {
                /*CSceneManager.Instance.groundBounceOptions.shakeCamOnBounce && */
    ...
    {
        //if (CGameManager.gameMode == GameMode.TrainingRoom && player_num == 2) return;
    ...
    private void resolveMove()
    {
        ...
        //if(currentMove != null && storedMove == null && !myOpenent.isDead)
        //{
        //    storedMove = moveSetScript.GetNextMove(currentMove);
        //}
    ...
    public void OnReleaseCam()
    {
        ...
        //    if(!hitedSkill) opPlayerScript.myPhysicsScript.freeze = false;
        //if(currentMove == null 
        //   || (currentMove != null && currentMove.gaugeSkillType != GaugeSkillType.Guard)
