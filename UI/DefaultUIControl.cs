...
public class DefaultUIControl : MonoBehaviour {
    ...
    //protected const float waitingTime = 0.2f;
    protected const float waitingTime = 0.4f;
    ...
    public virtual void FixedUpdateGOF()
    {
        if (isRunning)
        {
            ...
            //if (gameMgr.P1_Left.player.GetButtonDown("Pause") && Input_on && !isOn)
            ...
            //if (gameMgr.P2_Right.player.GetButtonDown("Pause") && Input_on && !isOn)
