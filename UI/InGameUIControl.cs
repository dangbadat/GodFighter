...
public class InGameUIControl : DefaultUIControl
{
    ...
    public override void OnHalfSkillImageAnimation(CharacterNames fighterName, int pMirror)
    {
        ...
        //{
        //    playerHalfSkill = skillData.HalfGaugeSkillMiho;


        //    //skillData.HalfGaugeSkillMiho.transform.position 
        //    //    = new Vector3(Screen.width * 2 * pMirror, skillData.HalfGaugeSkillMiho.transform.position.y, skillData.HalfGaugeSkillMiho.transform.position.z);

        //    //Sequence PlayMihoSKill_1 = DOTween.Sequence();
        //    //PlayMihoSKill_1.Insert(0, skillData.HalfGaugeSkillMiho.transform.DOMoveX(Screen.width * 2 * pMirror, 0.0f));
        //    //PlayMihoSKill_1.Insert(0, skillData.HalfGaugeSkillMiho.transform.DOMoveX(Screen.width / 2, 0.4f));
        //    //PlayMihoSKill_1.Insert(1, skillData.HalfGaugeSkillMiho.transform.DOMoveX(-Screen.width * 2 * pMirror, 0.2f));
        //}
        //else if (fighterName == CharacterNames.agni)
        //{
        //    playerHalfSkill = skillData.HalfGaugeSkillAgni;

        //    //skillData.HalfGaugeSkillAgni.transform.position
        //    //    = new Vector3(Screen.width * 2 * pMirror, skillData.HalfGaugeSkillAgni.transform.position.y, skillData.HalfGaugeSkillAgni.transform.position.z);

        //    //Sequence PlayAgniSKill_1 = DOTween.Sequence();
        //    //PlayAgniSKill_1.Insert(0, skillData.HalfGaugeSkillAgni.transform.DOMoveX(Screen.width * 2 * pMirror, 0.0f));
        //    //PlayAgniSKill_1.Insert(0, skillData.HalfGaugeSkillAgni.transform.DOMoveX(Screen.width / 2, 0.4f));
        //    //PlayAgniSKill_1.Insert(1, skillData.HalfGaugeSkillAgni.transform.DOMoveX(-Screen.width * 2 * pMirror, 0.2f));
        //}
        #endregion
    ...
    public override void SetHP(int playerNum, float curLife, bool reset)
    {
        ...
        //    {
        //        result_1p = 1.0f;
        //        pre_HP_result_1p = 1.0f;
        //        Left_HealthPoint.sprite = healthPointYellow;
        //        Left_HealthPoint.fillAmount = result_2p;
        //    }
        //    else
        //        HpCtrl_1P(curLife);
        //}
        ...
        //    {
        //        result_2p = 1.0f;
        //        pre_HP_result_2p = 1.0f;
        //        Right_HealthPoint.sprite = healthPointYellow;
        //        Right_HealthPoint.fillAmount = result_2p;
        //    }
        //    else
